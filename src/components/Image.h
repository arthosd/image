...
public:
    ...
    vector<int> treat_histogram(cv::Mat proj);                                // Renvoie les trois lignes significative
    ...
    cv::Mat hough_transform_prob(int tresh, int rho);                         // Calcul la transformé de hough probabiliste
